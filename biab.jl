...
landcovlayers = convert.(Float16, SimpleSDMPredictor(EarthEnv, LandCover, 1:12; full=false, boundaries...))
...
plot(heatmap(landcov),heatmap(climvelocity), heatmap(sdmuncertainty))
